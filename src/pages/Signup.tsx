    ...
    return (
      <main className="mx-auto flex min-h-screen w-full max-w-md items-center px-4 py-10">
        <section className="w-full rounded-lg border border-emerald-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-4 text-2xl font-bold text-slate-950">Account awaiting approval</h1>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Your account was created successfully. A super admin must verify it before you can log in.
          </p>
          <Link
            to="/login"
            className="mt-6 inline-flex w-full items-center justify-center rounded-md bg-slate-950 px-4 py-2 font-semibold text-white hover:bg-slate-800"
          >
            Return to login
          </Link>
        </section>
